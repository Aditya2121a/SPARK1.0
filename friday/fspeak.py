...
def track_emotion_phrases(text):
    if any(word in text.lower() for word in
           ['Love', 'Romance', 'Affection', 'Passion', 'Adoration', 'Devotion', 'Intimacy', 'Fondness', 'Tenderness',
            'Caring',
            'Warmth', 'Amour', 'Infatuation', 'Desire', 'Attraction', 'Yearning', 'Admiration', 'Enchantment',
            'Sweetheart', 'Soulmate',
            'Heartfelt', 'Tender', 'Embrace', 'Cherish', 'Butterfly', 'Sweetness', 'Amorous', 'Sentiment', 'Woo',
            'Serenade', 'Passionate',
            'Hug', 'Kiss', 'Whisper', 'Yearn', 'Lovers', 'Connection', 'Affinity', 'Magnetic', 'Attracted', 'Romance',
            'Cupid', 'Tenderhearted',
            'Beloved', 'Emotion', 'Fond', 'Harmony', 'Sympathy', 'Infatuated', 'Enamored', 'Darling', 'Tenderly',
            'Suitor', 'Enraptured',
            'Heartwarming', 'Softness', 'Heartthrob', 'Amicable', 'Attachment', 'Honeyed', 'Admirer', 'Yearning',
            'Adorned', 'Passionflower',
            'Swoon', 'Entranced', 'Enveloped', 'Heartfelt', 'Heartstrings', 'Enamored', 'Lovestruck', 'Warmhearted',
            'Adulating',
            'Companionate', 'Quixotic', 'Wooing', 'Nurturing', 'Stargazing', 'Whispers', 'Harmony', 'Languishing',
            'Enthralled',
            'Romeo', 'Juliet', 'Emblazoned', 'Fancy', 'Allure', 'Rapture', 'Yearning', 'Enraptured', 'Yearning',
            'Fantasy', 'Intoxication',
            'Longing', 'Alluring', 'Savor', 'Spark', 'Enchanted', 'Longing', 'Elation']
           ):
        return "love"
    elif any(word in text.lower() for word in
             ['Happy', 'Joyful', 'Pleased', 'Content', 'Cheerful', 'Delighted', 'Elated', 'Exuberant', 'Jovial',
              'Blissful',
              'Euphoric', 'Merry', 'Upbeat', 'Radiant', 'Sunny', 'Ecstatic', 'Buoyant', 'Lighthearted', 'Vibrant',
              'Carefree',
              'Satisfied', 'Optimistic', 'Whimsical', 'Playful', 'Jubilant', 'Grateful', 'Spirited', 'Enthusiastic',
              'Exhilarated',
              'Blessed', 'Mirthful', 'Gleeful', 'Hopeful', 'Sunny', 'Peppy', 'Zestful', 'Jocular', 'Sprightly', 'Jolly',
              'Animated',
              'Elfin', 'Satisfied', 'Blithe', 'Pleasurable', 'Radiant', 'Chipper', 'Jaunty', 'Chirpy', 'Upbeat',
              'Zippy']
             ):
        return "happy"
    elif any(word in text.lower() for word in
             ['Peaceful', 'Serene', 'Tranquil', 'Calm', 'Content', 'Satisfied', 'Pleased', 'Fulfilled', 'Blissful',
              'Harmonious',
              'Relaxed', 'At ease', 'Reassured', 'Placid', 'Soothed', 'Undisturbed', 'Gratified', 'Composed', 'Assured',
              'Tranquility',
              'Repose', 'Comforted', 'Untroubled', 'Quieted', 'Restful', 'Eased', 'At peace', 'Serenity', 'Easeful',
              'Balanced',
              'Steady', 'Hushed', 'Calmness', 'Heartsease', 'Pacified', 'Undisturbed', 'Placid', 'Halcyon',
              'Pacification', 'At rest',
              'Replenished', 'Mild', 'Equanimity', 'Centred', 'Unperturbed', 'Contentedness', 'Contentment',
              'Satisfaction', 'Ease']
             ):
        return "content"
    elif any(word in text.lower() for word in
             ['Neutral', 'Indifferent', 'Calm', 'Composed', 'Unaffected', 'Impartial', 'Detached', 'Unbiased',
              'Unemotional',
              'Dispassionate', 'Objective', 'Uninvolved', 'Unperturbed', 'Unresponsive', 'Stoic', 'Imperturbable',
              'Nonchalant',
              'Aloof', 'Distant', 'Equanimous', 'Balanced', 'Unflappable', 'Cool-headed', 'Serene', 'Tranquil',
              'Noncommittal',
              'Unfazed', 'Undisturbed', 'Unruffled', 'Untroubled', 'Easygoing', 'Unconcerned', 'Unexcitable', 'Unmoved',
              'Unfeeling',
              'Remote', 'Impassive', 'Unimpressed', 'Unworried', 'Nonplussed', 'Matter-of-fact', 'Unresponsive', 'Cool',
              'Reserved',
              'Untouched', 'Unbiased', 'Detached', 'Unprejudiced', 'Disinterested', 'Unbiased']
             ):
        return "neutral"
    elif any(word in text.lower() for word in
             ['Moody', 'Unsettled', 'Irritable', 'Restless', 'Discontent', 'Grumpy', 'Crabby', 'Testy', 'Peevish',
              'Gloomy',
              'Sullen', 'Sulky', 'Brooding', 'Fretful', 'Edgy', 'Perturbed', 'Tense', 'Restive', 'Anxious', 'Agitated',
              'Nervous',
              'Uneasy', 'Pouty', 'Choleric', 'Querulous', 'Cranky', 'Cross', 'Pensive', 'Melancholy', 'Blue',
              'Mournful', 'Downcast',
              'Glum', 'Lamenting', 'Wistful', 'Yearning', 'Displeased', 'Dissatisfied', 'Malcontent', 'Grumbling',
              'Craving',
              'Whining', 'Frowning', 'Dejected', 'Depressed', 'Dismal', 'Despondent', 'Downhearted', 'Worried',
              'Aggrieved', 'Miffed']
             ):
        return "moody"
    elif any(word in text.lower() for word in
             ['Sad', 'Unhappy', 'Mournful', 'Disheartened', 'Dejected', 'Downcast', 'Downhearted', 'Melancholy', 'Blue',
              'Sorrowful',
              'Depressed', 'Dismal', 'Despondent', 'Forlorn', 'Gloomy', 'Dreary', 'Woeful', 'Cheerless', 'Heartbroken',
              'Desolate',
              'Somber', 'Down in the dumps', 'Downhearted', 'Low-spirited', 'Downcast', 'Inconsolable', 'Miserable',
              'Glum', 'Morose',
              'Sullen', 'Wretched', 'Regretful', 'Lamenting', 'Grief-stricken', 'Long-faced', 'Woebegone', 'Doleful',
              'Heartrending',
              'Tearful', 'Funereal', 'Tragic', 'Mournful', 'Lachrymose', 'Weepy', 'Morbid', 'Anguished', 'Heavyhearted',
              'Sulky', 'Pensive']
             ):
        return "sad"
    elif any(word in text.lower() for word in
             ['Angry', 'Irate', 'Furious', 'Enraged', 'Agitated', 'Irritated', 'Infuriated', 'Incensed', 'Raging',
              'Indignant',
              'Wrathful', 'Livid', 'Maddened', 'Exasperated', 'Annoyed', 'Provoked', 'Irked', 'Fuming', 'Outraged',
              'Hostile',
              'Fierce', 'Resentful', 'Tempestuous', 'Stormy', 'Choleric', 'Vexed', 'Bitter', 'Offended', 'Cross',
              'Huffy', 'Riled',
              'Upset', 'Tumultuous', 'Spiteful', 'Sullen', 'Rancorous', 'Sour', 'Irritable', 'Testy', 'Petulant',
              'Peevish',
              'Incensed', 'Infuriated', 'Inflamed', 'Burning', 'Hot-tempered', 'Out of control', 'Wrath', 'Hostility',
              'Vehement']
             ):
        return "angry"
