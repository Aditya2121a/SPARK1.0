...
def AuthenticateFace():
    ...
    recognizer.read('C:\Programmes\SPARK 1.0\Auth\\trainer\\trainer.yml')  # load trained model
    cascadePath = "C:\Programmes\SPARK 1.0\Auth\\trainer\haarcascade_frontalface_default.xml"
